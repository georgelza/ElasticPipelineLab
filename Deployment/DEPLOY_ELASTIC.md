...
This document provides a comprehensive guide to deploy an Elastic stack for log analytics on Kubernetes. The setup includes Elasticsearch, Kibana, Filebeat, Syslog and Syslog-ng integration, with integration to Kafka for log routing.
...
This deployment guide provides a complete foundation for running an Elastic Stack on Kubernetes with support for log analytics, fall back storage options, and integration capabilities with existing infrastructure.